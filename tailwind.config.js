    ...
    theme: {
        extend: {
            backgroundImage: {
                ...
                'mesh-dark': 'radial-gradient(at 20% 30%, rgba(34,197,94,0.12) 0px, transparent 60%), radial-gradient(at 80% 20%, rgba(239,68,68,0.06) 0px, transparent 50%), radial-gradient(at 40% 80%, rgba(249,115,22,0.04) 0px, transparent 50%)',
                'mesh-admin': 'radial-gradient(at 0% 0%, rgba(5,150,105,0.08) 0px, transparent 50%), radial-gradient(at 100% 100%, rgba(16,185,129,0.05) 0px, transparent 50%)',
                'mesh-petani': 'radial-gradient(at 0% 0%, rgba(34,197,94,0.08) 0px, transparent 50%), radial-gradient(at 100% 100%, rgba(250,204,21,0.04) 0px, transparent 50%)',
                'mesh-pembeli': 'radial-gradient(at 0% 0%, rgba(20,184,166,0.08) 0px, transparent 50%), radial-gradient(at 100% 100%, rgba(236,72,153,0.04) 0px, transparent 50%)',
            },
            fontFamily: {
            ...
            boxShadow: {
                ...
                'card-dark-hover': '0 12px 40px rgba(0,0,0,0.5), 0 2px 8px rgba(0,0,0,0.3)',
