...
<div x-data="petaniLayout()" x-init="init()" class="min-h-screen flex">
    ...
    <aside id="sidebar"
        ...
        <div class="flex items-center gap-2.5 px-4 h-14 shrink-0 border-b border-gray-100">
            ...
            <span class="ml-auto text-[10px] font-medium text-green-500 bg-green-50 px-2 py-0.5 rounded-md">Petani</span>
        </div>
        ...
        <nav @click="sidebarOpen = false" class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
            ...
            @foreach($petaniNav as $item)
                <a href="{{ route($item['route']) }}"
                   class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-colors
                           {{ request()->routeIs($item['route']) ? 'bg-green-50 text-green-500 font-medium border-l-2 border-green-400' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
            ...
            <a href="{{ route('profile.edit') }}"
               class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-colors
                       {{ request()->routeIs('profile.edit') ? 'bg-green-50 text-green-500 font-medium border-l-2 border-green-400' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
            ...
            <div class="flex items-center justify-between h-14 px-4 sm:px-6 lg:px-10">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('shop.index') }}"
                       class="p-2 text-gray-600 hover:text-gray-600 transition-colors rounded-lg hover:bg-gray-50"
                       title="Lihat Toko">
                    ...
                    <x-dropdown align="right" width="52">
                        ...
                        <x-slot name="content">
                            <div class="px-4 py-3 border-b border-gray-100">
                                ...
                                <span class="inline-flex mt-1.5 px-2 py-0.5 text-[10px] font-medium bg-green-50 text-green-500 rounded-md">Petani</span>
                            </div>
