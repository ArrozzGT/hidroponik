...
<div x-data="petaniLayout()" x-init="init()" class="min-h-screen flex">
    ...
    <aside id="sidebar"
        ...
        <div class="flex items-center gap-2.5 px-4 h-14 shrink-0 border-b border-gray-100">
            <div class="w-7 h-7 rounded-lg bg-green-700 flex items-center justify-center">
            ...
            <span class="ml-auto text-[10px] font-medium text-green-700 bg-green-50 px-2 py-0.5 rounded-md">Petani</span>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
            ...
            @foreach($petaniNav as $item)
                <a href="{{ route($item['route']) }}"
                   class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-colors
                          {{ request()->routeIs($item['route']) ? 'bg-green-50 text-green-700 font-medium border-l-2 border-green-600' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
            ...
            <a href="{{ route('profile.edit') }}"
               class="flex items-center gap-2.5 px-3 py-2 text-sm rounded-lg transition-colors
                      {{ request()->routeIs('profile.edit') ? 'bg-green-50 text-green-700 font-medium border-l-2 border-green-600' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                    ...
                    <x-dropdown align="right" width="52">
                        ...
                        <x-slot name="content">
                            <div class="px-4 py-3 border-b border-gray-100">
                                ...
                                <span class="inline-flex mt-1.5 px-2 py-0.5 text-[10px] font-medium bg-green-50 text-green-700 rounded-md">Petani</span>
                            </div>
