        ...
        <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center gradient-green">
                    <i data-lucide="plus-circle" class="w-5 h-5 text-white" aria-hidden="true"></i>
                </div>
                <div>
                    <h1 class="text-2xl font-extrabold text-slate-900">Tambah Produk Baru</h1>
                    <p class="text-sm text-slate-500">Tambahkan produk dari kebun Anda</p>
                </div>
            </div>
            <a href="{{ route('petani.products.index') }}" class="btn-secondary">Kembali</a>
        </div>
        ...
        <div class="card p-6 sm:p-8">
            <form action="{{ route('petani.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <label for="image" class="flex flex-col items-center justify-center px-6 py-8 border-2 border-dashed border-slate-300 rounded-2xl bg-slate-50 hover:bg-green-50 cursor-pointer transition-colors">
                                ...
                                <span class="text-sm font-semibold text-slate-600">Klik untuk upload foto</span>
                                <span class="form-help">JPG, PNG, WebP maks 2MB</span>
                            </label>
                ...
                <div class="flex items-center justify-end gap-3 border-t border-slate-100 pt-6">
                    ...
                    <button type="submit" class="btn-primary"><i data-lucide="save" class="w-4 h-4" aria-hidden="true"></i> Simpan Produk</button>
                </div>
            </form>
        </div>
    </div>
